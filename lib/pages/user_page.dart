...
class UserPage extends StatelessWidget {
  ...
  const UserPage({required this.authProvider});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Column(
                  children: [
                        ...
                        Stack(
                          children: [
                            const Positioned(
                                ...
                                bottom: 0,
                                child: Image(
                                  image: AssetImage('assets/icons/edit-05.png'),
                                )),
                            Padding(
                    ...
                    Column(
                      children: [
                        listRow('graduation-hat-01', authProvider.role ?? '',
                            context),
                        listRow('pin-01', 'Publicidad', context),
                        listRow(
                            'bookmark-check', 'Ingeniería Comercial', context),
                      ],
                    ),
                    SizedBox(height: height * 0.02),
                    Column(
                    ...
                    Container(
                      width: width * 0.6,
                      child: Text('Universidad Autónoma Juan Misael Saracho',
                          maxLines: 2,
              ...
              const SizedBox(height: 5),
              Text('Facultad de Ciencias Empresariales',
                  textAlign: TextAlign.center,
                  style: TextStyle(
        ...
        child: Column(
          children: [
            ...
            TextButton(
              onPressed: () {
                final passUpdate =
                    Provider.of<UpdateFormProvider>(context, listen: false);
  ...
  void displayDialogAndroid(
      BuildContext context, LoginFormProvider authProvider) {
    showDialog(
                        ...
                        child: Column(
                          children: [
                            TextFormField(
                              ...
                              decoration: InputDecorations.authInputDecoration(
                                ...
                                suffixIcon: IconButton(
                                  icon: Icon(updateFormProvider.obscureText
                              ...
                              onChanged: (value) =>
                                  updateFormProvider.old_password = value,
                              validator: (value) {
                            ...
                            TextFormField(
                              ...
                              onChanged: (value) =>
                                  updateFormProvider.password = value,
                              validator: (value) {
                                return (value != null && value.length >= 5)
                                    ? null
                                    : 'Debe tener 5 o más caracteres';
                            ...
                            TextFormField(
                              ...
                              onChanged: (value) => updateFormProvider
                                  .passwordConfirmation = value,
                              validator: (value) {
                                return (value != null &&
                                        value == updateFormProvider.password)
                                    ? null
              ...
              actions: [
                Center(
                  child: SizedBox(
                    ...
                    child: CustomButton(
                      text: 'Guardar',
                      routeName: updateFormProvider.isLoading
                          ? null
                          : () async {
                              FocusScope.of(context).unfocus();
                              ...
                              print(authProvider.user!.id.toString());
                              print(updateFormProvider.old_password);
                              print(updateFormProvider.password);
                              print(updateFormProvider.passwordConfirmation);
